    ...
    `<div class="card mb-3">
        ...
        <div class="row g-0">
            <div class="col-md-3 text-center">
                  <img src="${vehicle.pictureUrl}" class="img-fluid rounded-start" alt="No photo" style="width: 160px">
            </div>
            <div class="col-md-9">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row justify-content-end mt-3">
                        <div class="col-md-auto">
                            <a href="/admin/editvehicle/${vehicle.vin}" type="button" class="btn btn-outline-dark px-5">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
